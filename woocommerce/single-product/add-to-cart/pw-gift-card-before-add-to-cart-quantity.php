...
?>
    ...
    <div id="pwgc-purchase-container" style="<?php echo $selected ? '' : 'display: none;'; ?>">
        <div class="pwgc-field-container">
            <label for="pwgc-to"
                   class="pwgc-label"><?php echo __( PWGC_TO_META_DISPLAY_NAME, 'pw-woocommerce-gift-cards' ); ?></label>
            <input type="text" id="pwgc-to" name="<?php echo PWGC_TO_META_KEY; ?>" class="pwgc-input-text"
                   placeholder="<?php _e( 'Entrer l\'adresse email du destinataire' ); ?>"
                   value="<?php echo $pwgc_to; ?>" required>
            <div class="pwgc-subtitle"><?php _e( 'Separate multiple email addresses with a comma.', 'pw-woocommerce-gift-cards' ); ?></div>
        </div>

        <div class="pwgc-field-container">
            <label for="pwgc-from"
                   class="pwgc-label"><?php echo __( PWGC_FROM_META_DISPLAY_NAME, 'pw-woocommerce-gift-cards' ); ?></label>
            <input type="text" id="pwgc-from" name="<?php echo PWGC_FROM_META_KEY; ?>" class="pwgc-input-text"
                   placeholder="<?php _e( 'Your name', 'pw-woocommerce-gift-cards' ); ?>"
                   value="<?php echo $pwgc_from; ?>" required>
        </div>

        <div class="pwgc-field-container">
            <label for="pwgc-message"
                   class="pwgc-label"><?php echo __( PWGC_MESSAGE_META_DISPLAY_NAME, 'pw-woocommerce-gift-cards' ); ?><?php _e( '(optional)', 'pw-woocommerce-gift-cards' ); ?></label>
            <textarea id="pwgc-message" name="<?php echo PWGC_MESSAGE_META_KEY; ?>"
                      placeholder="<?php _e( 'Add a message', 'pw-woocommerce-gift-cards' ); ?>"
                      maxlength="<?php echo PWGC_MAX_MESSAGE_CHARACTERS; ?>"><?php echo $pwgc_message; ?></textarea>
            <div class="pwgc-subtitle"><span
                        id="pwgc-message-characters-remaining"><?php echo PWGC_MAX_MESSAGE_CHARACTERS; ?></span> <?php _e( 'characters remaining', 'pw-woocommerce-gift-cards' ); ?>
            </div>
        </div>

        <div id="pwgc-quantity-one-per-recipient" class="pwgc-field-container">
            <div class="pwgc-label"><?php _e( 'Quantity', 'pw-woocommerce-gift-cards' ); ?>: <span
                        id="pwgc-recipient-count">1</span></div>
