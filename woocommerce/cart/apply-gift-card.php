	...
	<div id="pwgc-redeem-gift-card-form">
		<form id="pwgc-redeem-form">
			<div id="pwgc-redeem-gift-card-container">
				...
				<input type="text" id="pwgc-redeem-gift-card-number" name="card_number" autocomplete="off"
				       placeholder="<?php esc_html_e( 'Votre carte cadeau', 'pw-woocommerce-gift-cards' ); ?>">
